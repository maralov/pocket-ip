		...
		<div class="container-xxl">
			<div class="header__container">
				...
				<div class="d-flex">
					<div class="d-none d-lg-flex me-2 me-xl-4 order-lg-first">
						<?php
							...
							if( $book_link ):
								...
								?>
								<div class="px-2">
									<a class="btn btn-primary header-action-btn" href="<?php echo esc_url( $book_link_url ); ?>" target="<?php echo esc_attr( $book_link_target ); ?>"><?php echo esc_html( $book_link_title ); ?></a>
								</div>
						<?php endif; ?>
						<?php
							$try_link = get_field('main_btn_try', 'option');
							if( $try_link ):
								...
								?>
								<div class="px-2">
									<a class="btn btn-primary-outline header-action-btn" href="<?php echo esc_url( $try_link_url ); ?>" target="<?php echo esc_attr( $try_link_target ); ?>"><?php echo esc_html( $try_link_title ); ?></a>
								</div>
						<?php endif; ?>
					</div>
                    ...
                    <button type="button" class="btn btn-nav-search d-none d-lg-inline-flex js-btn-search header-btn-search"><?php pll_e('Search'); ?></button>
					<?php
						...
						if( $login_link ):
							...
							<a href="<?php echo esc_url( $login_link_url ); ?>"
								class="login-link d-flex align-items-center order-lg-first me-3 me-xxl-4" target="<?php echo esc_attr( $login_link_target ); ?>">

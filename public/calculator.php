                        ...
                        foreach ($country_terms as $slug => $term) {
                            ...
                            if ($price_items) {
                                foreach ($price_items as $price_item) {
                                    ...
                                    if (!empty($price_item_services)) {
                                        foreach ($price_item_services as $service) {
                                            $total_add_class_sum += (float) $service['price_item_add_class'];
                                        }
                                    } else {
                                        $total_add_class_sum += (float) $price_item['price_item_add_class'];
                                    }
                                }
                            }

                            $first_price_item_tooltip = '';
                            if ($price_items && isset($price_items[0]['price_item_txt_tooltip'])) {
                                $first_price_item_tooltip = $price_items[0]['price_item_txt_tooltip'];
                            }
                            ...
                            <div class="col">
                                <div class="country-card">
                                    <div class="row justify-content-between mb-2">
                                        ...
                                        <div class="col-auto d-flex gap-1">
                                            <span class="text-bold"><?php echo esc_html($total_sum_all_items); ?>$</span>
                                            <div class="country-info">
                                                ...
                                                <div class="country-info__tooltip">
                                                    ...
                                                    ?>
                                                    <?php echo esc_html($total_add_class_sum); ?>$.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        foreach ($country_terms as $slug => $term) {
                            ...
                            if ($price_items) {
                                foreach ($price_items as $price_item) {
                                    ...
                                    if (!empty($price_item_services)) {
                                        foreach ($price_item_services as $service) {
                                            $total_add_class_sum += (float) $service['price_ren_item_add_class'];
                                        }
                                    } else {
                                        $total_add_class_sum += (float) $price_item['price_ren_item_add_class'];
                                    }
                                }
                            }

                            $first_price_item_tooltip = '';
                            if ($price_items && isset($price_items[0]['price_ren_item_txt_tooltip'])) {
                                $first_price_item_tooltip = $price_items[0]['price_ren_item_txt_tooltip'];
                            }
                                    ...
                                    <div class="modal details-modal js-modal-<?php echo esc_attr($slug); ?>">
                                        <div class="position-relative modal-submit__content">
                                            ...
                                            <div class="box box--white box--lg box--radius-lg">
                                                <div class="price-card">
                                                    <div class="price-card__header">
                                                        <a href="<?php echo esc_url($service_link); ?>" target="_blank" class="d-flex gap-1">
                                                            <?php if ($category_icon) : ?>
                                                                <img src="<?php echo esc_url($category_icon['url']); ?>" alt="<?php echo esc_attr($term->name); ?>" width="20" height="20" />
                                                            <?php endif; ?>
                                                            <span class="text-bold"><?php echo esc_html($term->name); ?></span>

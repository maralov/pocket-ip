        ...
        <?php if( have_rows('custom_blocks', $term) ): while ( have_rows('custom_blocks', $term) ) : the_row(); ?>
                            ...
                            <?php
                                ...
                                if (!empty($image_banner)): ?>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <?php endif; ?>
                                        alt="<?php echo esc_attr($image_banner['alt']); ?>">
                                    </div>
                                <?php endif; ?>
                        </div>
                    </div>
            ...
            <?php if( get_row_layout() == 'software_block' ): ?>
                <section class="page-section">
                    ...
                    <!--
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xxl-5 justify-content-center">
                            <div class="col col-s mt-3 pt-1 mt-sm-0 pt-sm-0 d-flex">
                                <div class="box box--radius-lg box--white box--shadow">
                                    <div
                                        class="box box--sm box--radius-sm box--red w-auto d-inline-flex justify-content-center mb-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-hit-1.svg" alt="">
                                    </div>
                                    <p class="subtitle-2 mb-2">Integrate portfolio automatically</p>
                                    <p class="paragraph-sm">Make your trademark records fast and easy – all the data will
                                        automatically
                                        be uploaded from official registers. It’s no need to do it manually!</p>
                                </div>
                            </div>
                            <div class="col col-s mt-3 pt-1 mt-sm-0 pt-sm-0 d-flex">
                                <div class="box box--radius-lg box--white box--shadow">
                                    <div
                                        class="box box--sm box--radius-sm box--red w-auto d-inline-flex justify-content-center mb-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-hit-2.svg" alt="">
                                    </div>
                                    <p class="subtitle-2 mb-2">Docketing with automatically updated statuses </p>
                                    <p class="paragraph-sm">The trademark registrations and applications are tied with records
                                        in official trademark databases.</p>
                                </div>
                            </div>
                            <div class="col col-s mt-3 pt-1 mt-md-0 pt-md-0 d-flex">
                                <div class="box box--radius-lg box--white box--shadow">
                                    <div
                                        class="box box--sm box--radius-sm box--red w-auto d-inline-flex justify-content-center mb-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-hit-3.svg" alt="">
                                    </div>
                                    <p class="subtitle-2 mb-2">Prepare reports, work in teams</p>
                                    <p class="paragraph-sm">Upload the trademark portfolio reporting and search results in
                                        convenient formats. Create teams within the service and share objects and tasks.</p>
                                </div>
                            </div>
                            <div class="col col-s mt-3 pt-1 mt-xxl-0 pt-xxl-0 d-flex">
                                <div class="box box--radius-lg box--white box--shadow">
                                    <div
                                        class="box box--sm box--radius-sm box--red w-auto d-inline-flex justify-content-center mb-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-hit-3.svg" alt="">
                                    </div>
                                    <p class="subtitle-2 mb-2">Make searches and monitoring</p>
                                    <p class="paragraph-sm">Integrated national and international databases provide option to
                                        make searches and create goals for monitoring in different countries.</p>
                                </div>
                            </div>
                            <div class="col col-s mt-3 pt-1 mt-xxl-0 pt-xxl-0 d-flex">
                                <div class="box box--radius-lg box--white box--shadow">
                                    ...
                                    <p class="subtitle-2 mb-2">Set the tasks</p>
                                    <p class="paragraph-sm">No need to find somewhere a lawyer to make trademark renewal,
                                        change trademark information, or file a trademark application – do it right here with a
                                        couple
                                        of clicks.</p>
                                </div>
                            </div>
                ...
                <section class="page-section page-section--bg-grey">
                    <div class="container-lg">
                        <div class="row row-cols-1 row-cols-md-2">
                            ...
                            <?php endif; ?>
                        <!--
                            <div class="col d-flex flex-column mb-4 mb-xl-5">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-search.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Integrated search forms</a>
                                </div>
                                <p class="m-0">Conduct searches within TM databases of different countries and international
                                    registration systems in one place</p>
                            </div>
                            <div class="col d-flex flex-column mb-4 mb-xl-5">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-request.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Online application system</a>
                                </div>
                                <p class="m-0">All stages of finding a foreign lawyer and giving instructions in a few click
                                </p>
                            </div>
                            <div class="col d-flex flex-column mb-4 mb-md-0">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-warning.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Alerting system</a>
                                </div>
                                <p class="m-0">Monitoring system allows to set up of notifications when applying for
                                    registration of
                                    similar trademarks. Analyze the trademark strategy of your competitors</p>
                            </div>
                            <div class="col d-flex flex-column">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-international.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Global coverage</a>
                                </div>
                                <p class="m-0">Managing intellectual property objects all over the world from one online account</p>
                            </div>
                        -->
                        </div>
                    </div>
                    ...
                    <div class="container-lg">
                        ...
                        <!--
                            <div class="col d-flex flex-column mb-4 mb-xl-5">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-website.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Trademark application</a>
                                </div>
                            ...
                            <div class="col d-flex flex-column mb-4 mb-md-0">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-renewal.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Trademark renewal</a>
                                </div>
                                <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            </div>
                            <div class="col d-flex flex-column">
                                <div class="d-flex mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-clipboard.svg" alt="">
                                    </div>
                                    <a href="" class="h3">Trademark assignment</a>
                                </div>
                                <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            </div>
                        -->
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex">
                                            <div class="avatar avatar-lg">
                                                <?php if(get_sub_field('reviews_block_items_avatar')): ?>
                                                <img src="<?php echo get_sub_field('reviews_block_items_avatar')['url']; ?>" alt="avatar">
                                                <?php endif;?>
                                                <div>
                                        ...
                                        <a href="<?php the_sub_field('reviews_block_items_url'); ?>">
                                            <?php if(get_sub_field('reviews_block_items_icon')): ?>
                                            <img src="<?php echo get_sub_field('reviews_block_items_icon')['url']; ?>" alt="<?php echo get_sub_field('reviews_block_items_icon')['alt']; ?>">
                                            <?php endif;?>
                                        </a>
                                        <?php endif;?>
                                    </div>
                            ...
                            <!--
                                <div class="box box--white box--shadow content h-100 mb-1">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex">
                                            <div class="avatar avatar-lg">
                                                <img src="<?php echo POCKET_IMG_DIR; ?>/avatar.png" alt="avatar">
                                                <div>
                                                    <span>Savannah Nguyen</span>
                                                    <span class="text-bold">Founder</span>
                                                </div>
                                            </div>
                                        </div>
                                        <a href="https://linkedin.com">
                                            <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-linkedin.svg" alt="">
                                        </a>
                                    </div>
                                    <p>Curabitur tempor quis eros tempus lacinia. Nam bibendum pellentesque quam a convallis.
                                        Sed ut vulputate
                                        nisi. Integer in felis sed leo vestibulum venenatis. Suspendisse quis arcu sem. Aenean
                                        feugiat ex eu
                                        vestibulum vestibulum. Morbi a eleifend magna. Nam metus lacus, porttitor eu mauris a,
                                        blandit ultrices
                                        nibh. Mauris sit amet magna non ligula vestibulum eleifend. Nulla varius volutpat turpis
                                        sed lacinia.
                                        Nam eget mi in purus lobortis eleifend. Sed nec ante dictum sem condimentum ullamcorper
                                        quis venenatis
                                        nisi. Proin vitae facilisis nisi, ac posuere leo.</p>
                                </div>
                                <div class="box box--white box--shadow content h-100 mb-1">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex">
                                        ...
                                        <a href="https://linkedin.com">
                                            <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-instagram.svg" alt="">
                                        </a>
                                    </div>
                                    <p>Curabitur tempor quis eros tempus lacinia. Nam bibendum pellentesque quam a convallis.
                                        Sed ut vulputate
                                        ...
                                        vestibulum vestibulum. Morbi a eleifend magna. Nam metus lacus, porttitor eu mauris a,
                                        blandit ultrices
                                        nibh. Mauris sit amet magna i, ac posuere leo.</p>
                                </div>
                                <div class="box box--white box--shadow content h-100 mb-1">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex">
                                        ...
                                        <a href="https://linkedin.com">
                                            <img src="<?php echo POCKET_IMG_DIR; ?>/icons/ic-twitter.svg" alt="">
                                        </a>
                                    </div>
                                    <p>Curabitur tempor quis eros tempus lacinia. Nam bibendum pellentesque quam a convallis.
                                        Sed ut vulputate
            ...
            <!-- <div class="container-lg">
                <div class="cta-block">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto mb-3 mb-md-0 col-md-6">
                            <p class="m-0 h2">Call to action</p>
                        </div>
                        <div class="col-auto">
                            <a href="https://my.pocketip.com/" class="btn btn-primary">Try demo now</a>
                        </div>
                    </div>
                </div>
            </div> -->
                ...
                <section class="page-section ">
                    <div class="container-lg">
                        ...
                        <div class="pricing mb-4" data-price="year">
                            ...
                            <?php while ( have_rows('price_block_item') ) : the_row(); ?>
            ...
            <!-- <section class="page-section ">
                <div class="container-lg">
                    <div class="row justify-content-center">
                        <div class="col col-xxl-6">
                            <h2 class="h2 section-h2 mb-2 mb-xl-3 pb-xl-1">Still not convinced? Compare us with other tools
                            </h2>
                        </div>
                    </div>
                    <div class="slider slider-rows">
                        <div class="slider__wrapper">
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-1.svg" alt="partner-logo-1"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-2.svg" alt="partner-logo-2"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-3.svg" alt="partner-logo-3"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-4.svg" alt="partner-logo-4"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-5.svg" alt="partner-logo-5"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-6.svg" alt="partner-logo-6"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-7.svg" alt="partner-logo-7"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-8.svg" alt="partner-logo-8"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-1.svg" alt="partner-logo-1"></div>
                            <div class="box py-4 box--white box--shadow d-flex align-items-center justify-content-center">
                                <img src="<?php echo POCKET_IMG_DIR; ?>/partners/p-2.svg" alt="partner-logo-2"></div>
                ...
                <section class="page-section pt-0">
                    <div class="container-lg ">
                        ...
                        <div class="slider slider-card">
                            ...
                            <?php
                                ...
                                <div class="card">
                                    ...
                                    <div class="p-3 p-xxl-4">
                                        ...
                                        <h5 class="h3 mb-2 pb-xxl-1"><?php echo esc_html($title); ?></h5>
                            ...
                            <!--
                                <div class="card">
                                    <img src="<?php echo POCKET_IMG_DIR; ?>/blog-1.jpg" class="card-img" alt="Heading news">
                                    <div class="p-3 p-xxl-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2 pb-xxl-1">
                                            <div class="avatar">
                                                <img src="<?php echo POCKET_IMG_DIR; ?>/avatar.png" alt="avatar">
                                                <div><span>Savannah Nguyen</span></div>
                                            </div>
                                            <div class="card-date">01.01.2001, 14:40</div>
                                        </div>
                                        <h5 class="h3 mb-2 pb-xxl-1">Heading news</h5>
                                        <p class="paragraph mb-2 pb-xxl-1">Nam pulvinar blandit velit, id condimentum diam
                                            faucibus at.
                                            Aliquam lacus
                                            nisi, sollicitudin at nisi nec, fermentum congue felis. Quisque mauris dolo...</p>
                                        <a href="/blog.html" class="link link-icon">
                                            <span>Read blog</span>
                                            <svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                ...
                                <div class="card">
                                    <img src="<?php echo POCKET_IMG_DIR; ?>/blog-2.jpg" class="card-img" alt="Heading news">
                                    <div class="p-3 p-xxl-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2 pb-xxl-1">
                                            <div class="avatar">
                                                <img src="<?php echo POCKET_IMG_DIR; ?>/avatar.png" alt="avatar">
                                ...
                                <div class="card">
                                    <img src="<?php echo POCKET_IMG_DIR; ?>/blog-3.jpg" class="card-img" alt="Heading news">
                                    <div class="p-3 p-xxl-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2 pb-xxl-1">
                                            <div class="avatar">
                                                <img src="<?php echo POCKET_IMG_DIR; ?>/avatar.png" alt="avatar">
            ...
            <!-- <div class="container-lg">
                <div class="cta-block">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto mb-3 mb-md-0 col-md-6">
                            <p class="m-0 h2">Ready to step up your social selling game?</p>
                        </div>
                        <div class="col-auto">
                            <a href="https://my.pocketip.com/" class="btn btn-primary">Start 7-day free trial</a>
                        </div>
                    </div>
                </div>
            </div> -->
